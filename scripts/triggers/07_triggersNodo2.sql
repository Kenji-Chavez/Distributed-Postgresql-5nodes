-- 1. CREACIÓN DE LA FOREIGN TABLE en el Nodo 2
-- Esto permite que el Nodo 2 pueda escribir en la tabla 'pedidos_replica' del Nodo 5.
...
DROP FOREIGN TABLE IF EXISTS pedidos_replica_ft;
--------------------------------------------------------------------------------
-- Trigger 1: Sincronización de Réplica
-- Creación del trigger en el nodo 2
