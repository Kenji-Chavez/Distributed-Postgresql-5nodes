...
UPDATE "order_details" SET discount = 0.45 WHERE order_id = 10249 AND product_id = 51;
------------------------------------------------------------------
SELECT discount FROM "order_details" WHERE order_id = 10249 AND product_id = 51;